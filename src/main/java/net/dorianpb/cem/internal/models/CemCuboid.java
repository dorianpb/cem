...
public class CemCuboid extends ModelPart.Cuboid {
    private static final Set<Direction>  directions = Set.of(Direction.NORTH,
                                                             Direction.SOUTH,
                                                             Direction.EAST,
                                                             Direction.WEST,
                                                             Direction.UP,
    ...
    CemCuboid(float x,
        ...
        this.sides[4] = new ModelPart.Quad(this.sides[4].vertices,
                                           uvNorth[0],
                                           uvNorth[1],
                                           uvNorth[2],
                                           uvNorth[3],
                                           ...
                                           false,
                                           Direction.NORTH);
        this.sides[5] = new ModelPart.Quad(this.sides[5].vertices,
                                           uvSouth[0],
                                           uvSouth[1],
                                           uvSouth[2],
                                           uvSouth[3],
                                           ...
                                           false,
                                           Direction.SOUTH);
        this.sides[0] = new ModelPart.Quad(this.sides[0].vertices,
                                           uvEast[0],
                                           uvEast[1],
                                           uvEast[2],
                                           uvEast[3],
                                           ...
                                           false,
                                           Direction.EAST);
        this.sides[1] = new ModelPart.Quad(this.sides[1].vertices,
                                           uvWest[0],
                                           uvWest[1],
                                           uvWest[2],
                                           uvWest[3],
                                           ...
                                           false,
                                           Direction.WEST);
        this.sides[2] = new ModelPart.Quad(this.sides[2].vertices,
                                           uvDown[0],
                                           uvDown[1],
                                           uvDown[2],
                                           uvDown[3],
                                           ...
                                           false,
                                           Direction.DOWN);
        this.sides[3] = new ModelPart.Quad(this.sides[3].vertices,
                                           uvUp[0],
                                           uvUp[1],
                                           uvUp[2],
                                           uvUp[3],
    ...
    public CemCuboid(float x,
        ...
        super(u,
              ...
              textureHeight,
              directions);
        this.params = new CemCuboidTexOffsetParams(x,
                                                   y,
                                                   z,
                                                   sizeX,
                                                   sizeY,
